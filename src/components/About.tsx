          ...
          <div className="flex-1">
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="text-3xl md:text-5xl font-bold text-white uppercase tracking-tighter">About Me</h2>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                <p className="text-slate-300 text-lg leading-relaxed mb-6">
                  As a passionate software developer, I thrive in the dynamic tech landscape, embracing challenges for continuous growth. With a solid background in computer science, I bring adept programming and creative problem-solving skills to each project.
                </p>
                <p className="text-slate-300 text-lg leading-relaxed">
                  I prioritize functionality, efficiency, and user-friendly design, while also exploring unconventional solutions. Beyond work, I actively engage with new technologies, collaborate with peers, and stay updated on industry trends. I&apos;m on a perpetual journey of evolution, pushing boundaries and eagerly anticipating the exciting prospects the future holds.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="tech-card p-6 rounded-xl flex gap-4 items-start hover:border-orange-500/50 transition-all">
                  ...
                  <div className="w-full">
                    <h3 className="text-xl font-bold text-white mb-4 uppercase tracking-wider">Education</h3>
                    ...
                    <div className="space-y-8">
                      <div className="relative pl-6 border-l border-white/10">
                        ...
                        <p className="text-orange-500/80 text-sm font-medium mt-1">BRAC University • 2022 - Present</p>
                      ...
                      <div className="relative pl-6 border-l border-white/10">
                        ...
                        <p className="text-orange-500/60 text-sm font-medium mt-1">Govt. Azizul Haque College • 2018 - 2020</p>
                      ...
                      <div className="relative pl-6 border-l border-white/10">
                        ...
                        <p className="text-orange-500/40 text-sm font-medium mt-1">Bogura Zilla School • 2010 - 2018</p>
                        <p className="text-slate-500 text-xs mt-1 uppercase tracking-wider">Bogura, Bangladesh • GPA: 5.00</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="tech-card p-6 rounded-xl flex gap-4 items-start hover:border-orange-500/50 transition-all">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-1 uppercase tracking-wider">Development Approach</h3>
